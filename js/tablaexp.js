...
datatable = $('#tablaexp').DataTable({
          ...
          },
          {
            ...
            funcion='editar';
            $.post('controlador/LaboratorioController.php',{funcion,id,causa,medida,fechadeentrada,fechadesalida,comisaria,nroexpediente,librodeactas,fojas,denunciado},(response)=>{
                //alert(response);
